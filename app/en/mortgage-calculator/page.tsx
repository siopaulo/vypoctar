...
export default function MortgageCalculatorPageEN() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            <HomeIcon className="h-8 w-8 text-indigo-600 dark:text-indigo-400 mr-3" />
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Mortgage Calculator</h1>
          </div>
            ...
            <div className="mt-8 space-y-4">
              <div className="p-6 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                ...
                <p className="text-3xl font-bold text-indigo-700 dark:text-indigo-400">
                  {result.monthlyPayment.toLocaleString('en-US', { maximumFractionDigits: 2 })} CZK
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    {result.totalPayment.toLocaleString('en-US', { maximumFractionDigits: 2 })} CZK
                  </p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total interest:</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    {result.totalInterest.toLocaleString('en-US', { maximumFractionDigits: 2 })} CZK
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">About Mortgage Calculator</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            This calculator helps you estimate your monthly mortgage payment. The calculation is based on an annuity
            payment, where the payment amount remains constant throughout the loan term.
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            <strong>Note:</strong> The actual payment amount may be affected by additional factors such as
            insurance, fees and other costs. For an accurate calculation, contact your bank.
          </p>
        </div>
      </main>
    </div>
