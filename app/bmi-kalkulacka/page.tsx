      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">BMI Kalkulačka</h1>
          </div>

          <p className="text-gray-600 dark:text-gray-300 mb-6">
            BMI (Body Mass Index) je ukazatel, který pomáhá posoudit, zda je vaše hmotnost v normálním rozmezí.
          </p>
          ...
          {bmi !== null && category && (
            <div className="mt-8 space-y-4">
              <div className="p-6 bg-orange-50 dark:bg-orange-900/20 rounded-lg text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Vaše BMI:</p>
                <p className="text-5xl font-bold text-orange-700 dark:text-orange-400 mb-4">
                  {bmi.toFixed(1)}
                </p>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  <strong>Popis:</strong> {category.description}
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
                  <strong>Poznámka:</strong> BMI je orientační ukazatel. Pro přesné posouzení zdravotního stavu
                  se poraďte s lékařem nebo odborníkem na výživu.
                </p>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">O BMI kalkulačce</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            BMI (Body Mass Index) je jednoduchý ukazatel, který pomáhá posoudit, zda je vaše hmotnost
            vzhledem k výšce v normálním rozmezí. Vzorec: BMI = hmotnost (kg) / výška (m)²
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            <strong>Důležité:</strong> BMI je orientační nástroj a nezohledňuje složení těla (svaly vs. tuk).
            Pro přesné posouzení zdravotního stavu se vždy poraďte s lékařem.
          </p>
        </div>
      </main>
    </div>
